(function () {/*VERSION:250808*/
    function checkWebviewCustomUA(a) {
        for (var b = ["daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; d < e; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    ...
    window.kakao = window.kakao || {}, window.daum ? window.kakao = window.daum : window.daum = window.kakao, function (a) {
        function b(a) {
            var b = {};
    ...
    }(window.kakao), "object" != typeof JSON && (JSON = {}), function () {
        "use strict";
        ...
        function str(a, b) {
            ...
            switch (i && "object" == typeof i && "function" == typeof i.toJSON && (i = i.toJSON(a)), "function" == typeof rep && (i = rep.call(b, a, i)), typeof i) {
                ...
                case"object":
                    ...
                    if (rep && "object" == typeof rep) for (f = rep.length, c = 0; c < f; c += 1) "string" == typeof rep[c] && (d = rep[c], e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e)); else for (d in i) Object.prototype.hasOwnProperty.call(i, d) && (e = str(d, i), e && g.push(quote(d) + (gap ? ": " : ":") + e));
                    return e = 0 === g.length ? "{}" : gap ? "{\n" + gap + g.join(",\n" + gap) + "\n" + h + "}" : "{" + g.join(",") + "}", gap = h, e
            }
        }
    ...
    postcodeUtils.param = function (a) {
        ...
        if (c.length >= 1) for (var d = 0, e = c.length; d < e; d++) {
            var f = c[d];
        ...
        isTouch: "ontouchstart" in window, on: function (a, b, c) {
            ...
            var c = b ? b.start : null, d = b ? b.move : null, e = b ? b.end : null, f = !1, g = !1, h = this, i = -1,
                j = -1, k = 10;
            a && (this.on(a, "touchstart", function (a) {
                ...
                h.stopPropagation(a);
                var b = a.changedTouches && a.changedTouches[0] || a.touches && a.touches[0] || null, c = b && b.pageX,
                    e = b && b.pageY, f = Math.abs(i - c), l = Math.abs(j - e);
        ...
        for (var b = ["lg-f5", "lg-f4", "lg-f3", "d6503"], c = !1, d = 0, e = b.length; d < e; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    }, postcodeUtils.isAndroidWebview = function (a) {
        for (var b = ["version/", "samsungbrowser", "daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; d < e; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    }, postcodeUtils.isAndroidNaverWebview = function (a) {
        for (var b = ["naver"], c = !1, d = 0, e = b.length; d < e; d++) if (a.indexOf(b[d]) > -1) {
            c = !0;
            break
        }
        return c
    ...
    !function (a, b, c, d, e) {
        ...
        a.CONT = {
            ...
            function o(a) {
                for (var b in q.POPUP_MAP) if (q.POPUP_MAP.hasOwnProperty(b)) for (var c = q.POPUP_MAP[b], d = 0, e = c.length; d < e; d++) if (a === c[d].ref) return c[d];
                return null
            }
    ...
    var v2 = v2 || {};
    !function (a, b, c, d, e) {
        var f = b, g = a.CONT, h = a.viewUtils, i = a.MODEL, j = a.common, k = a.dataUtils;
        a.frame = function () {
            function a(a) {
            ...
            function b(a) {
                var b = d.createElement("iframe"), c = {
                    position: "absolute",
                    left: "0",
                    top: "0",
                    width: "100%",
            ...
            function m(a) {
                ...
                }, d = a.popupKey || "_blank", e = c.open("", d, f.getStringByOptions(b, "=", ","));
            ...
            function n(a, b) {
                ...
                j.setReady(c, function (c, d) {
                    "done" === c ? b.onComplete !== g.EMPTY_FUNCTION && setTimeout(function () {
                        ...
                        if (b.onComplete(d), b.autoClose) if (b.onClose !== g.EMPTY_FUNCTION) {
            ...
            function o(a) {
                ...
                if (d) for (var e = c.getElementsByTagName("iframe"), f = 0, g = e.length; f < g; f++) {
                    var h = e[f].id || null;
            ...
            var q = null, r = null, s = null, t = function (a) {
                var b = {
                    border: "0 none",
                    margin: "0",
                    width: "100%",
        ...
        a.themePreprocessor = function () {
            function a(a) {
                for (var b = !1, c = u, d = 0, e = c.length; d < e; d++) {
                    ...
                    if (j && f.isHex(j)) for (var k = 0, l = i.length; k < l; k++) {
            ...
            function b(a) {
                for (var b = v, d = !1, e = 0, g = b.length; e < g; e++) for (var h = b[e], i = h.keys, j = h.match, k = h.modifier, l = 0, m = j.length; l < m; l++) {
            ...
            }], v = [{keys: [s.SEARCH_BG], match: [["SEARCH.placeHolder", "#bbb"]], modifier: d}, {
                keys: [s.SEARCH_BG],
    ...
    !function (a, b, c, d, e, f) {
        ...
        function m(a) {
            ...
            if (c.width = d.value, c.isFlexibleWidth = d.isFlexible, c.height = e.value, c.isFlexibleHeight = e.isFlexible, c.onComplete && "function" == typeof c.onComplete && c.onComplete !== r.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== r.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = r.EMPTY_FUNCTION, c.oncomplete = r.EMPTY_FUNCTION, c.isViewerMode = !0), c.onResize && "function" == typeof c.onResize && c.onResize !== r.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== r.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = r.EMPTY_FUNCTION, c.onresize = r.EMPTY_FUNCTION), c.onClose && "function" == typeof c.onClose && c.onClose !== r.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== r.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = r.EMPTY_FUNCTION, c.onclose = r.EMPTY_FUNCTION), c.onSearch && "function" == typeof c.onSearch && c.onSearch !== r.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== r.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = r.EMPTY_FUNCTION, c.onsearch = r.EMPTY_FUNCTION), "boolean" != typeof c.autoMappingJibun && (c.autoMappingJibun = !0), "boolean" != typeof c.autoMappingRoad && (c.autoMappingRoad = !0), "boolean" != typeof c.autoMapping && (c.autoMapping = !0), "boolean" == typeof a.autoMapping && (c.autoMappingJibun = c.autoMappingRoad = c.autoMapping), "boolean" != typeof c.animation && (c.animation = !1), "boolean" != typeof c.shorthand && (c.shorthand = !0), "boolean" != typeof c.focusInput && (c.focusInput = !0), "boolean" != typeof c.focusContent && (c.focusContent = !0), "boolean" != typeof c.hideMapBtn && (c.hideMapBtn = !1), "boolean" != typeof c.hideEngBtn && (c.hideEngBtn = !1), "boolean" != typeof c.showMoreHName && (c.showMoreHName = !1), "boolean" != typeof c.alwaysShowEngAddr ? c.alwaysShowEngAddr = !1 : c.alwaysShowEngAddr && (c.hideEngBtn = !0), "boolean" != typeof c.submitMode && (c.submitMode = !0), "boolean" != typeof c.useSuggest && (c.useSuggest = !0), "boolean" != typeof c.autoHiddenSuggest && (c.autoHiddenSuggest = !1), isNaN(c.pleaseReadGuide) || "number" != typeof c.pleaseReadGuide ? c.pleaseReadGuide = 0 : (c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10), c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0), c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)), isNaN(c.pleaseReadGuideTimer) || "number" != typeof c.pleaseReadGuideTimer ? c.pleaseReadGuideTimer = 1.5 : (c.pleaseReadGuideTimer = parseFloat(c.pleaseReadGuideTimer), c.pleaseReadGuideTimer <= 0 && (c.pleaseReadGuideTimer = 1.5), c.pleaseReadGuideTimer > 60 && (c.pleaseReadGuideTimer = 1.5)), isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems ? c.maxSuggestItems = 10 : (c.maxSuggestItems = parseInt(c.maxSuggestItems, 10), (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) && (c.maxSuggestItems = 10)),
                c.windowHeightAvailableForSuggest = 45 * c.maxSuggestItems + 50, c.theme) {
        ...
        var p = b, q = c, r = a.CONT, s = a.MODEL, t = a.viewUtils, u = a.frame, v = a.themePreprocessor,
            w = "http:" !== a.CONT.PROTOCOL, x = (w ? "https:" : "http:") + "//postcode.map.daum.net/search",
            y = encodeURIComponent(r.PROTOCOL + "//" + f.host), z = encodeURIComponent(f.pathname), A = "",
            B = x + "?origin=" + y;
        u.init(B, z, A), m.prototype = {
            open: function (a) {
                if (!o(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    ...
                    b = h(b, a), b = i(b, a), b = j(b, a), b = k(b, a), b = l(b, a), b = p.extend(b, {viewType: "popup"}), u.popup.create(b)
                }
            }, embed: function (a, b) {
                if (!o(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    var c = p.extend({}, this._opt_);
                    c = h(c, b), c = k(c, b), c = p.extend(c, {viewType: "layer"}), u.layer.create(c, a)
                }
            }
        }, d.daum.Postcode = m
